...
/* harmony export */   "fillResult": () => (/* binding */ fillResult),
...
const convertUnit = () => {
    ...
    changedElem.forEach((ele) => {
      let textAnimation = (0,animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_0__["default"])({
        targets: changedElem,
        opacity: [0, 1],
        translateY: [-8, 0],
        duration: 1500,
...
async function submitHandler() {
  if (validateInput()) {
    try {
      let fetchWeatherData = await (0,_api_js__WEBPACK_IMPORTED_MODULE_1__.weatherRequest)(
        cityInput.value
      ).then((data) => (0,_api_js__WEBPACK_IMPORTED_MODULE_1__.fillResult)((0,_api_js__WEBPACK_IMPORTED_MODULE_1__.filterData)(data)));

      let resultScreenAnimation = (0,animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_0__["default"])({
    ...
    let inputAnimation = await (0,animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_0__["default"])({
      targets: cityInput,
      translateX: [-20, 0],
    });
  }
...
locBtn.addEventListener('click', (event) => {
  ...
  const successCallback = (location) => {
    ...
    (0,_api_js__WEBPACK_IMPORTED_MODULE_1__.weatherRequest)(userLocation).then((data) => (0,_api_js__WEBPACK_IMPORTED_MODULE_1__.fillResult)((0,_api_js__WEBPACK_IMPORTED_MODULE_1__.filterData)(data)))
    let resultScreenAnimation = (0,animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_0__["default"])({
      targets: resultScreen,
      opacity: [0, 1],
      translateY: [-10, 0],
...
async function resetHandler() {
  ...
  let mainScreenAnimation = (0,animejs_lib_anime_es__WEBPACK_IMPORTED_MODULE_0__["default"])({
    targets: mainScreen,
    opacity: [0, 1],
    translateY: [-20, 0],
    duration: 3000,
...
convertBtn.addEventListener('click', (e) => {
    (0,_api_js__WEBPACK_IMPORTED_MODULE_1__.convertUnit)();
  //Switch button text
  convertBtn.innerText = _api_js__WEBPACK_IMPORTED_MODULE_1__.units == 'metric' ? '℉' : '℃';
});
